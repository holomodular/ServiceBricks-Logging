...
namespace ServiceBricks.Logging.SqlServer
{
    ...
    /// </summary>
    public sealed class LoggingSqlServerModuleAddRule : BusinessRule
    {
        /// <summary>
        /// Register the rule
        /// </summary>
        ...
        {
            registry.Register(
                typeof(ModuleAddEvent<LoggingSqlServerModule>),
                typeof(LoggingSqlServerModuleAddRule));
        }
        ...
        public override IResponse ExecuteRule(IBusinessRuleContext context)
        {
            ...
            var e = context.Object as ModuleAddEvent<LoggingSqlServerModule>;
